...
class Controller extends RendererController{
    ...
    onOpen(data) {
        ...
        chooser.placeholder = "Choose a resources folder with assets and data"

        let name = new forms.FormField('name','mod name');
        name.placeholder = "WildNature Mod 1.15.2";
        let codename = new forms.FormField('codename','mod codename');
        codename.placeholder = "wildnature";

        form.addEntries(chooser,name,codename);

        //-------------------
        let saveButton = new forms.Button('Create',() => {
